    ...
    describe(`Test spot trading orderbook and trades`, async () => {
        ...
        it(`it should work`, async () => {
            ...
            try {
                ...
                await sleep(5000)
                console.log('Increase collateral token price...')
                await tomojsM.tomox.setCollateralPrice({
                    token: '0x0000000000000000000000000000000000000001',
                    lendingToken: token.contractAddress,
                    price: new BigNumber(1).multipliedBy(1e18).toString(10)
                })
                ...
                while(true) {
                    let blockNumber = parseInt(await tomojsM.tomo.getBlockNumber())
                    console.log('Testing for the auto topup a deleted trade happens', blockNumber, blockNumber % 900)
